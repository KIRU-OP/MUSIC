...
from LolMusic import YouTube, app
from LolMusic.core.call import Sona as Anony
from LolMusic.misc import db, SUDOERS
from LolMusic.utils import AdminRightsCheck, seconds_to_min
