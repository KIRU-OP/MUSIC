...
#BOT FILE NAME
from LolMusic import app as app
from LolMusic.mongo.couples_db import _get_image, get_couple
...
async def ctest(_, message):
    ...
    try:
        ...
        try:
            ...
            p1 = "LolMusic/assets/upic.png"
        try:
            p2 = await app.download_media(photo2.big_file_id, file_name="pfp1.png")
        except Exception:
            p2 = "LolMusic/assets/upic.png"
            
        img1 = Image.open(f"{p1}")
        img2 = Image.open(f"{p2}")

        img = Image.open("LolMusic/assets/cppic.png")
